...
const UPSELLS = [
  { name: "Thé Earl Grey Royal", priceCents: 1800, image: IMAGES.tea, alt: "Thé Earl Grey" },
  { name: "Champagne Rosé", priceCents: 5500, image: IMAGES.champagne, alt: "Champagne Rosé" },
  { name: "Caramel à la Fleur de Sel", priceCents: 1250, image: IMAGES.caramel, alt: "Caramel fleur de sel" },
  { name: "Bougie \"Douceur Vanillée\"", priceCents: 2200, image: IMAGES.candle, alt: "Bougie vanillée" },
] as const;
    ...
    <>
      ...
      <main className="mx-auto max-w-container-max px-margin-mobile pb-32 pt-24 md:px-margin-desktop">
        ...
        <section className="mt-24">
          <h2 className="mb-12 text-center font-display text-headline-md text-secondary">
